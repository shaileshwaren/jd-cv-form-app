...
description: JD→CV scorer (compact). Parses JD, normalizes te..., applies compliance & floor rules, outputs tables + decision.

COMMAND INPUT FLEXIBILITY (as requested)
...
- /generate rubric
    • Already accepts raw JD text; no change required
